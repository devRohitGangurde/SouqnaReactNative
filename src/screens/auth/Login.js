    ...
    return (
      <ScrollView style={styles.loginContainer}>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 2 }}>
            <Headline
              style={{ fontSize: 30, paddingTop: 16, color: colors.colorWhite }}
            >
              Welcome
            </Headline>
            <Headline
              style={{ fontSize: 30, paddingTop: 8, color: colors.colorWhite }}
            >
              Back . . .
            </Headline>
          </View>
        ...
        >
          ...
          <Text onPress={() => this.props.navigation.navigate("Signup")}>
            <Text style={{ color: colors.colorSecondary }}>Sign Up</Text>
          </Text>
        </Text>
      </ScrollView>
    );
