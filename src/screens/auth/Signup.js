        ...
        return (
            <ScrollView style={styles.loginContainer}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ flex: 2 }}>
                        <Headline style={{ fontSize: 30, fontWeight: 'bold', paddingTop: 16, color: '#fff' }}>New</Headline>
                        <Headline style={{ fontSize: 30, fontWeight: 'bold', paddingTop: 8, color: '#fff' }}>Account</Headline>
                    </View>
                    <View style={{ flex: 1 }}>
                    <Image
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 32 }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <TextInput
                            theme={{ colors: { text: colors.colorWhite, primary: colors.colorSecondary } }}
                            style={{ backgroundColor: colors.colorPrimary }}
                            placeholder='Email' placeholderTextColor={colors.colorGray} textColor={'white'} underlineColor={'white'} />
                    </View>
                </View>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 32 }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <TextInput
                            theme={{ colors: { text: colors.colorWhite, primary: colors.colorSecondary } }}
                            style={{ backgroundColor: colors.colorPrimary }}
                            placeholder='Phone Number' placeholderTextColor={colors.colorGray} textColor={'white'} underlineColor={'white'} />
                    </View>
                </View>
                ...
                <Button
                    ...
                    onPress={() => props.navigation.navigate('bottom_tabs')}>Sign Up</Button>

                <Text style={{ color: '#fff', textAlign: 'center', marginTop: 32 }}>or</Text>
                <Text style={{ color: '#fff', textAlign: 'center', marginTop: 32 }}><Ionicons name='logo-google' size={16} color={colors.colorSecondary} /> Login with Google</Text>
                <Text style={{ color: '#fff', textAlign: 'center', marginTop: 32 }}>Already have an account? <Text onPress={() => props.navigation.navigate('login')}><Text style={{ color: colors.colorSecondary }}>Sign In</Text></Text></Text>
